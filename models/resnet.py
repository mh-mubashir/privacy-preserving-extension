...
class ResNetEncoder(nn.Module):
    def __init__(self, block, in_channels=3):
...
if __name__ == "__main__":
    # net = ResNetEncoder(BasicBlock, in_channels=1).to("cuda")
    net = ResNet18(in_channels=1).to("cuda")
    # net = nn.Linear(224*224, 10000).to("cuda")
    net.eval()
    # print(net)

    x = torch.randn(1, 1, 224, 224).to("cuda") 
    macs = torchprofile.profile_macs(net, (x,))
